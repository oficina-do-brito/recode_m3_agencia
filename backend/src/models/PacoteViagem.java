...
public class PacoteViagem implements ICRUD{
	...
	public PacoteViagem(String titulo, Integer valorDesconto, double precoTotal, String possuiHospedagem,
	...
	public String toString() {
		return "PacoteViagem [titulo=" + titulo + ", valorDesconto=" + valorDesconto + ", precoTotal=" + precoTotal
				+ ", possuiHospedagem=" + possuiHospedagem + ", status=" + status + ", meioTransporte="
				+ meioTransporte + ", imagem=" + imagem + ", prazoCancelamento=" + prazoCancelamento
				+ ", dataViagem=" + dataViagem + ", idOrigemDestino=" + idOrigemDestino + ", idHospedagem="
				+ idHospedagem + ", idCarrinhoCompra=" + idCarrinhoCompra + "]";
	}
	public void recuperarPacotevIagemById(int id){
		PacoteViagem pr = this.pacoteViagemDAO.findById(id);
		this.id = pr.id;this.titulo = pr.titulo;
		this.valorDesconto = pr.valorDesconto;this.precoTotal = pr.precoTotal;
		this.possuiHospedagem = pr.possuiHospedagem;this.status = pr.status;
		this.meioTransporte = pr.meioTransporte;this.imagem = pr.imagem;
		this.prazoCancelamento = pr.prazoCancelamento;this.dataViagem = pr.dataViagem;
		this.idOrigemDestino = pr.idOrigemDestino;this.idHospedagem = pr.idHospedagem;
